...
package com.willchun.library.fragment;

import com.willchun.library.R;
import com.willchun.library.base.AndFragment;
...
public abstract class ProgressFragment extends AndFragment{
    ...
    private boolean canEmptyClick = true;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return (aq = new AndQuery(getAndActivity(), inflater.inflate(R.layout.willchun_lib_fragment_progress, container, false)))
                .getView();
    }
    ...
    public void setCanEmptyClick(boolean canEmptyClick) {
        this.canEmptyClick = canEmptyClick;
    }
